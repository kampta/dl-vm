...
MAINTAINER Kamal Gupta <kamalgupta308@gmail.com.com>
...
# Install OpenCV
RUN wget https://github.com/opencv/opencv/archive/$OPENCV_VERSION.zip -O /root/opencv.zip && \
    cd /root && unzip opencv.zip && cd opencv-$OPENCV_VERSION && \
	mkdir build && \
	cd build && \
